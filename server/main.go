...
func (s *Server) GetEvents(w http.ResponseWriter, r *http.Request) {
	...
	homepage_req.AddCookie(&http.Cookie{
		Name:  "OptanonConsent",
		Value: "consentId=ca5945b7-bcc1-46be-86eb-bf2b4a85ee1b&datestamp=Sat+Feb+10+2024+14%3A49%3A17+GMT-0700+(Mountain+Standard+Time)&version=6.33.0&interactionCount=0",
	})
